...
<body>
    ...
    <div class="box-login">
        <label class="ok" for="email">Email:</label>
        <input class="email_login" name="email" required="required" type="email" />
    </div>
    <div class="box-login">
        <label class="ok" for="senha">Senha:</label>
        <input class="email_login" name="senha" required="required" type="password" />
    </div>
    <div class="box-login">
